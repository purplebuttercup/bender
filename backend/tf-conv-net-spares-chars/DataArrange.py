...
for line in f.readlines():
    ...
    if (3 < len(rest)):
        ...
        if (len(rest[3]) < 30):
            ...
            if (nr % 11 == 0):
                val_set_xx = []
                val_set_xx = val_set_xx + [0]*1682
                i = 0

                for c in rest[3]:
                    if (c != '\n'):
                        val_set_xx[58 * i + Matrix.alfa.index(c)] = 1
                        i = i + 1
                ...
                test_set_xx = []
                test_set_xx = test_set_xx + [0]*1682
                i = 0
                charCount = 0
                wordCount = 0
                ...
                for c in rest[3]:
                    if (c != '\n'):
                        test_set_xx[58 * i + Matrix.alfa.index(c)] = 1
                        i = i + 1
                ...
                train_set_xx = []
                train_set_xx = train_set_xx + [0]*1682
                i = 0
                charCount = 0
                wordCount = 0
                ...
                for c in rest[3]:
                    if (c != '\n'):
                        train_set_xx[58 * i + Matrix.alfa.index(c)] = 1
                        i = i + 1
            ...
            if (maxWords < len(rest[3])):
                maxWords = len(rest[3])

print ("Max chars : ", maxWords)
