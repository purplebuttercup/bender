...
def load_data_and_labels(validation):
    ...
    if (not validation):
        ...
        test_inputs = [clean_str(te_s) for te_s in test_inputs]
        test_inputs = [s.split(" ") for s in test_inputs]
        val_inputs = [clean_str(va_s) for va_s in val_inputs]
...
def load_data():
    ...
    train_sentences, train_labels, test_sentences, test_labels = load_data_and_labels(validation=False)
...
def load_data_eval():
    ...
    train_sentences, train_labels, test_sentences, test_labels, val_sentences, val_labels = load_data_and_labels(validation=True)
