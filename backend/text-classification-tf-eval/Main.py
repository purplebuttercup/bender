...
tf.flags.DEFINE_integer("embedding_size", 128, "Dimensionality of character embedding")
tf.flags.DEFINE_string("filters", "2,3,4,5", "Comma-separated filter sizes")
tf.flags.DEFINE_integer("filer_size", 84, "Number of filters per filter size")
...
with g.as_default():
    ...
    with sess.as_default():
        ...
        #generate batches
        batches = Loader.batch_generator(list(zip(x_train, y_train)), FLAGS.batch, FLAGS.epochs, validation=False)
